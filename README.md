# Gamifiedpersonalweb
A personal website that is like an 8 bit game, like the vibe of the one in Ready Player One.
It ended up becoming a website for with some fun games built into like some sort of virtual CV.
...
It is also hosted on cloudflare pages to the url jamesos.pages.dev

This is for my second last midnight project in hackclub and hope all is good with it.
